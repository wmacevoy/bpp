...
public class BPPFilter extends StageFilter {
  ...
  public void setNameSpace(bsh.NameSpace _nameSpace) { nameSpace=_nameSpace; }
  ...
  */
  ...
  public Filter getStageFilter() {
    ...
    if (stage%2==1) {
      ...
      if (err != null) factory.setErr(err);
      if (nameSpace != null) factory.setNameSpace(nameSpace);
      if (parent != null) factory.setParent(parent);
      ...
      if (filterName != null) {
	    ...
	    if (mode == '\'') f.defaultCommand=f.exactCommand;
	    else f.defaultCommand=f.magicCommand;
	    return f;
    }
  }
}

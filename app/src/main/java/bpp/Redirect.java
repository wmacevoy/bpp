...
/**
 * <p>
 * This class simplifies redirecting standard output (System.out) to different
 * streams. The old output stream is maintained on a stack and is restored with
 * end()
 * </p>
 * 
 * <p>
 * <b>WARNING</b>This Redirect works with access through System.out. Beanshell's
 * <code>print()</code> statement apparently caches its PrintStream, so this
 * redirect <i>will not work</i> with beanshell. Use the
 * <code>redirect.bsh</code> scripts instead.
 * </p>
 * 
 * <br/>
...
public class Redirect {
  public static final LinkedList<OutputStream> redirects = new LinkedList<OutputStream>();

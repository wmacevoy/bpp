...
public class BPPFilter extends StageFilter {
  ...
  /** When new stages are forked, this is the source name given to the 
      ...
      as bp.source in all stages of the preprocessor. */
  public void setSource(String _source) { source=_source; }

  public String getSource() { return source; }

  /** Convenience method. Destination is available as bp.destination in
      all stages of the preprocessor. */
  public void setDestination(String _destination) { destination=_destination; }
  public String getDestination() { return destination; }

  /** Convenience method.  Args are available as bp.args in all stages
      of the processor. */
...
nn	</table>
  ...
  */
  ...
  public Filter getStageFilter() {
    ...
    int depth = (stage+1)/2;
    if (stage%2==1) {
	    return new BeanshellInterpreterFilter(new Factory(depth));
    } else {
	    BeanshellDecoratorFilter f = new BeanshellDecoratorFilter(depth,lineNumber);
